...
module.exports = function (addressObject) {
    const fundingAddressStateMachine = new StateMachine(
        ...
        [
            {
                ...
                fetchers: [
                    {name: 'enoughDagcoins', masterAddress: addressObject.master_address, deviceAddress: addressObject.master_device_address},
        ...
        [
            ...
            {
                fromState: 'new', toState: 'cannot-fuel', checkCondition: (data) => {
                    return !data['enoughDagcoins'];
                }
            },
            {
                fromState: 'new', toState: 'need-fuel', checkCondition: (data) => {
                    return data['enoughDagcoins'] && !data['enoughBytes'];
                }
            },
            {
                fromState: 'new', toState: 'void', checkCondition: (data) => {
                    return false;
                }
            },
            {
            ...
            {
                fromState: 'can-fuel-ready', toState: 'void', checkCondition: (data) => {
                    return false;
                }
            },
            {
            ...
            {
                fromState: 'need-fuel', toState: 'void', checkCondition: (data) => {
                    return false;
                }
            },
            {
            ...
            {
                fromState: 'cannot-fuel', toState: 'void', checkCondition: (data) => {
                    return false;
                }
            }
        ]
